...
Page({
  ...
  pickerChange(e) {
    ...
    console.log('gyq4', e)
    console.log('gyq5', e.detail)
    console.log('gyq6', e.detail.value)
    if (e.detail.value >= 0) {
      that.setData({
        unreserveTime: [],
      }, function () {
        that.SevenFloor()
        console.log('gyq222222', that.data.unreserveTime)
      })
  ...
  btnClick: function () {
    if (app.globalData.startTimeText == '') {
      ...
      console.log('gyq', app.globalData.username)
  ...
  onLoad: function (options) {
    ...
    db.collection('order').orderBy('startTime', 'desc').where({
      ...
      success: res => {
        ...
        console.log('gyq7', temp)
        console.log('gyq8', temp2)
        // temp2.reverse()
        that.setData({
          unreserveTime: temp,
          orderInfo: temp2,
  ...
  SevenFloor: function () {
    ...
    db.collection('order').orderBy('startTime', 'desc').where({
      ...
      success: res => {
        ...
        console.log('gyq9', temp)
        console.log('gyq10', temp2)
        ...
        console.log('gyq3333333333', that.data.unreserveTime)

        console.log('gyqgyqgyq')
        console.log('gyq11', that.data.unreserveTime)
        console.log('gyq12', that.data.orderInfo)
